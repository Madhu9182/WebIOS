...
public class MethodOverriding {
	...
	public static void main(String[] args) {
		...
		//Creating objects for sub classes with super class reference
		...
		But if the sub class methods are override and when we call that method
		then override method will get...
		 */
